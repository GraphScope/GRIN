...
void grin_destroy_value_from_vertex_property_table(GRIN_GRAPH, GRIN_DATATYPE, const void*);
#endif
...
void grin_destroy_value_from_edge_property_table(GRIN_GRAPH, GRIN_DATATYPE, const void*);
#endif
