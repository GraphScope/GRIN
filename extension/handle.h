...
typedef void* GRIN_INDEXED_ADJACENT_LIST_ITERATOR;

typedef struct GRIN_INDEXED_ADJACENT_LIST_ITERATOR_T {
    GRIN_VERTEX src;
    GRIN_EDGE_TYPE edge_type;
    GRIN_DIRECTION direction;
    GRIN_ADJACENT_LIST_ITERATOR iterator;
} GRIN_INDEXED_ADJACENT_LIST_ITERATOR_T;
// #endif
