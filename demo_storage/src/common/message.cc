...
const char* grin_get_static_storage_feature_msg() {
...

  {
    ...
    LOG(ERROR)
        << "GRIN_ENABLE_VERTEX_LIST_ARRAY requires GRIN_ENABLE_VERTEX_LIST"
#endif
           feature->add_vertex_list_retrievals(
               grin::ListRetrieval::LR_ARRAY_LIKE);
#endif

#ifdef GRIN_ENABLE_VERTEX_LIST_ITERATOR
#ifndef GRIN_ENABLE_VERTEX_LIST
    LOG(ERROR)
        << "GRIN_ENABLE_VERTEX_LIST_ITERATOR requires GRIN_ENABLE_VERTEX_LIST"
#endif
           feature->add_vertex_list_retrievals(
               grin::ListRetrieval::LR_ITERATOR);
#endif
...
#endif
                  feature->add_edge_list_retrievals(
                      grin::ListRetrieval::LR_ARRAY_LIKE);
#endif
...
#ifndef GRIN_ENABLE_EDGE_LIST
    LOG(ERROR)
        << "GRIN_ENABLE_EDGE_LIST_ITERATOR requires GRIN_ENABLE_EDGE_LIST"
#endif
    ...
    LOG(ERROR)
        << "GRIN_ENABLE_ADJACENT_LIST_ARRAY requires GRIN_ENABLE_ADJACENT_LIST"
#endif
           feature->add_adjacent_list_retrievals(
               grin::ListRetrieval::LR_ARRAY_LIKE);
#endif

#ifdef GRIN_ENABLE_ADJACENT_LIST_ITERATOR
#ifndef GRIN_ENABLE_ADJACENT_LIST
    LOG(ERROR) << "GRIN_ENABLE_ADJACENT_LIST_ITERATOR requires "
                  "GRIN_ENABLE_ADJACENT_LIST"
#endif
                  feature->add_adjacent_list_retrievals(
                      grin::ListRetrieval::LR_ITERATOR);
#endif
